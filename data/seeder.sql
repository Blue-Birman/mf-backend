/**
  * CUSTOMERS
 */
INSERT INTO `customers` (`id`, `name`, `email`, `password`, `address`, `created_at`, `updated_at`)
VALUES (1, 'Alessandro', 'rvalessandro@gmail.com', 'rv123', 'Bali no 2', '2020-12-08', '2020-12-08'),
...
/**
  * CATEGORIES
 */
INSERT INTO millenial_fashion.categories (id, name, created_at, updated_at)
VALUES (1, 'Men', '2020-12-08', '2020-12-08');
INSERT INTO millenial_fashion.categories (id, name, created_at, updated_at)
VALUES (2, 'Women', '2020-12-08', '2020-12-08');

/**
  * PRODUCTS
 */
INSERT INTO millenial_fashion.products (id, category_id, name, description, image_url, preview_url, price, created_at,
                                        updated_at)
VALUES (1, 1, 'White Clothes', 'White clothes with elastic fiber, appropiate for hard sporting, will absorb sweat fast',
        'assets/product/set_1.png', null, '1000000', '2020-12-08', '2020-12-08');
INSERT INTO millenial_fashion.products (id, category_id, name, description, image_url, preview_url, price, created_at,
                                        updated_at)
VALUES (2, 1, 'Blue Clothes', 'blue clothes with elastic fiber, appropiate for hard sporting, will absorb sweat fast',
        'assets/product/set_2.png', null, '1500000', '2020-12-08', '2020-12-08');
INSERT INTO millenial_fashion.products (id, category_id, name, description, image_url, preview_url, price, created_at,
                                        updated_at)
VALUES (3, 1, 'Blue Mask', 'Blue mask with thick fiber, will always block dust and virus from outside in',
        'assets/product/set_3.png', null, '1250000', '2020-12-08', '2020-12-08');
INSERT INTO millenial_fashion.products (id, category_id, name, description, image_url, preview_url, price, created_at,
                                        updated_at)
VALUES (4, 1, 'Purple Mask', 'Purple mask with thick fiber, will always block dust and virus from outside in',
        'assets/product/set_4.png', null, '2000000', '2020-12-08', '2020-12-08');
INSERT INTO millenial_fashion.products (id, category_id, name, description, image_url, preview_url, price, created_at,
                                        updated_at)
VALUES (5, 2, 'White fiber cloth',
...
INSERT INTO millenial_fashion.products (id, category_id, name, description, image_url, preview_url, price, created_at,
                                        updated_at)
VALUES (7, 2, 'Red White fiber cloth',
...
INSERT INTO millenial_fashion.products (id, category_id, name, description, image_url, preview_url, price, created_at,
                                        updated_at)
VALUES (8, 2, 'Blue Tiger fiber cloth',
